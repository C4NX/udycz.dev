<template>
  <label class="swap swap-rotate btn btn-ghost" aria-label="Toggle theme">
    <input type="checkbox" @change="toggleTheme" :checked="isDarkTheme" />
    <Icon name="mdi:white-balance-sunny" size="24" class="swap-off" />
    <Icon name="mdi:weather-night" size="24" class="swap-on" />
  </label>
</template>
